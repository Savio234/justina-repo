...
var require_postcss_import = __commonJS({
  ...
  ${charset.node.params} specified in ${charset.node.source.input.file}`);
          ...
          function loadImportContent(result2, stmt, filename, options2, state2) {
            ...
            return Promise.resolve(options2.load(filename, options2)).then((content) => {
              if (content.trim() === "") {
              ...
              if (state2.hashFiles[content] && state2.hashFiles[content][media])
                return;
              return processContent(result2, content, filename, options2, postcss).then((importedResult) => {
